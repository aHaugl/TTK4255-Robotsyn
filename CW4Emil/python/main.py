...
for image_number in [21]:  # Use this to run on a single image
    ...
    # TASK: Compute calibrated image coordinates
    ...
    print(
        ...
        f'min={diff_min}, mean={diff_mean}, max={diff_max}')
